...
struct super_operations {
  ...
  int (*statfs)(struct vfs_superblock *sb, void *buf);
};
...
struct filesystem_type {
  ...
  struct vfs_superblock* (*mount)(uint dev, void *data);
...
// Mount table entry
struct vfsmount {
  struct vfs_superblock *mnt_sb;         // Mounted filesystem's superblock
